...
uses
  Winapi.Windows, System.Classes, System.Generics.Collections, System.SysUtils, Vcl.Controls, Vcl.ExtCtrls, Vcl.Forms, Vcl.Graphics,
  TextEditor.Consts, TextEditor.Marks;
...
type
  ...
  TTextEditorCustomLineColorsEvent = procedure(const ASender: TObject; const ALine: Integer; var AUseColors: Boolean; var AForeground: TColor; var ABackground: TColor) of object;
  TTextEditorCustomTokenAttributeEvent = procedure(const ASender: TObject; const AText: string; const ALine: Integer; const AChar: Integer; var AForegroundColor: TColor; var ABackgroundColor: TColor; var AStyles: TFontStyles; var AUnderline: TTextEditorUnderline; var AUnderlineColor: TColor) of object;
  ...
  TTextEditorLinePaintEvent = procedure(const ASender: TObject; const ACanvas: TCanvas; const ARect: TRect;const ALineNumber: Integer; const AIsMinimapLine: Boolean) of object;
  ...
  TTextEditorMarkPanelLinePaintEvent = procedure(const ASender: TObject; const ACanvas: TCanvas; const ARect: TRect; const ALineNumber: Integer) of object;
  TTextEditorMarkPanelPaintEvent = procedure(const ASender: TObject; const ACanvas: TCanvas; const ARect: TRect; const AFirstLine: Integer; const ALastLine: Integer) of object;
