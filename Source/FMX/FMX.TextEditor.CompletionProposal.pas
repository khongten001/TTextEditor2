unit FMX.TextEditor.CompletionProposal;

interface

uses
  System.Classes, FMX.TextEditor.CompletionProposal.Snippets, FMX.TextEditor.CompletionProposal.Trigger, FMX.TextEditor.Types;
...
uses
  System.SysUtils, FMX.TextEditor.Consts, FMX.TextEditor.KeyCommands;
...
begin
  ...
  FShortCut := TextEditorShortCut(Ord(' '), [ssCtrl]);
