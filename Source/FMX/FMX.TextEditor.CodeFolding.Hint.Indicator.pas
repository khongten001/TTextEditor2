unit FMX.TextEditor.CodeFolding.Hint.Indicator;

interface

uses
  System.Classes, FMX.Controls, FMX.TextEditor.Glyph, FMX.TextEditor.Types;
...
begin
  Result := FGlyph.Visible or (FGlyph.Left <> 2) or (FGlyph.MaskColor <> TAlphaColors.Null);
end;
