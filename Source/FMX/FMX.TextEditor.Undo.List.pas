unit FMX.TextEditor.Undo.List;

interface

uses
  System.Classes, FMX.TextEditor.Types, FMX.TextEditor.Undo.Item;
...
type
  ...
  public
    ...
    procedure AddChange(AReason: TTextEditorChangeReason;
      const ACaretPosition, ASelectionStartPosition, ASelectionEndPosition: TTextEditorTextPosition;
...
begin
  ...
  begin
    ...
    for var LIndex := 0 to (ASource as TTextEditorUndoList).FItems.Count - 1 do
    begin
...
begin
  ...
  begin
    ...
    begin
      ...
      ChangeBeginPosition := ASelectionStartPosition;
