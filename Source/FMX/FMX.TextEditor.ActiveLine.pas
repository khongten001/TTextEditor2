unit FMX.TextEditor.ActiveLine;

interface

uses
  System.Classes, System.UITypes, FMX.TextEditor.Glyph, FMX.TextEditor.Types;
...
begin
  Result := FIndicator.Visible or (FIndicator.MaskColor <> TAlphaColors.Null) or (FIndicator.Left <> 2);
end;
